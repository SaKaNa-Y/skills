# Separate Project Setup from Background Triage

Yak Shaving Triage may be selected by the model at the start of engineering work as well as by the user, because requiring the user to notice drift before activating protection weakens its preventive purpose. Setup Sakana Skills remains user-invoked and establishes shared tracker conventions and selected agent-document entrypoints; skills read those conventions directly, with no setup prerequisite or runtime router.
